        ...
        <div className="my-24 md:px-14 px-4 max-w-screen-2xl mx-auto" id='feature'>
            <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
                ...
                className="lg:w-1/4">
                    ...
                    <p>A simple paragraph is comprised of three major components. The first sentence, which is 
                        often a declarative sentence, is called the "topic sentece."</p>
                </div>
                {/* Features Cards */}
                ...
                <div className='grid md:grid-cols-3 sm:grid-cols-1 items-start md:gap-12 gap-8'>
                    <div className='bg-[rgba(255, 255, 255, 0.04)] rounded-[35px] h-96 shadow-3xl p-8
                        item-center flex justify-center items-center hover:-translate-y-4 transition-all
